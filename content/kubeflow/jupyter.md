...
Copy the [sample training code](/kubeflow/kubeflow.files/mnist-tensorflow.py) and paste it in the first code block. This Python sample code uses TensorFlow to create a training model for MNIST database. Click on **Run** to load this code in notebook.
