...
Alternatively, you can use [Dockerfile](https://eksworkshop.com/kubeflow/kubeflow.files/Dockerfile) to build the image by using the command below. We will skip this step for now
```
